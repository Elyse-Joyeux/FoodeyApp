---
labels: ['foodey-service', 'express', 'server', 'microservice']
description: 'foodey service'
---

A foodey-service component. Provides a RESTful API for the platform.
...
```bash
bit use foodey-service
```

Run the server:
```bash
bit run foodey-service
```
